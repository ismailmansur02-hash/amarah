...
const LEGAL_DOCS = {
  privacy: {
    ...
    body: [
      ...
      ["p", "Subscriptions are processed by Apple (App Store) or Google (Play Store) and managed through RevenueCat, our subscription infrastructure provider. We never receive or store your card details. RevenueCat receives a pseudonymous identifier linked to your account to manage your subscription status."],
      ["h", "Third parties we use"],
      ["p", "Supabase (authentication and database hosting), RevenueCat (subscription management), and Apple / Google (sign-in and payment). Each processes data only to provide their part of the service. We do not sell your data to anyone, ever."],
      ["h", "Your rights"],
  ...
  terms: {
    ...
    body: [
      ...
      ["h", "Subscriptions"],
      ["p", "Some features require a paid subscription, billed through the App Store or Play Store. Subscriptions renew automatically unless cancelled at least 24 hours before the end of the current period. Manage or cancel your subscription in your Apple ID or Google Play account settings. Refunds are handled under the policies of the relevant store."],
      ["h", "Acceptable use"],
