...
# A noon exit was adopted 2026-08-24 and REVERTED 2026-08-25 after a 2026-only
# test: at matched risk the 21:45 clock earns more (+15.5% vs +11.8% full
# period), and in 2026 the afternoon block pays significantly (paired t=+3.73).
# The apparent improvement came from the sizing increase, not the clock.
# See backtest/REPORT.md "Hold-time revision, and its reversal".
